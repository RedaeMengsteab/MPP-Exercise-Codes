package lesson10.lecture.generics.signatures;
import java.util.*;
...
public class MapOperation {
	public static void main(String[] args) {
		...
		List<Number> numbers =
				//here, type R is Number and word.length() is of type Integer T
				words.stream().map(word -> word.length())
				              .collect(Collectors.toList());
		numbers.addAll(someDoubles);
		        //here, type T is Manager, and Employee is super type, return Salary R type Integer
