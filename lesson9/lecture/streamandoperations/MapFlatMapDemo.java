...
public class MapFlatMapDemo {
	public static void main(String[] args) {
        ...
        Stream<Stream<String>> result = words.stream().map(w->letters(w));//produce stream of stream
      ...
      //  Stream<String> flatresult = words.stream().flatMap(w->letters(w));
       ...
       List <String> flatresult1 = words.stream().flatMap(w->letters(w))//produce single list
